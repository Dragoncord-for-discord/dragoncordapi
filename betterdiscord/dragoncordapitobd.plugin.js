...
class DragoncordAPItoBD {
    ...
    // Meta
    getName() { return "DragoncordAPI to Better Discord"; }
    getShortName() { return "Official port DragoncordAPI to Powercord"; }
    getDescription() { return "Official port DragoncordAPI to Powercord"; }
    getVersion() { return "1.0.0"; }
    getAuthor() { return "DragonFire"; }
    ...
    start() {}
    stop() {
        alert("DragoncordAPI to BD", "Reload BD to apply changes");
    };
}
